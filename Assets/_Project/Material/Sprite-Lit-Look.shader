Shader "Universal Render Pipeline/2D/Sprite-Lit-Look"
{
    Properties
    {
		...
		[Toggle(_FLIPX)] _FlipX("FlipX", Int) = 0
    }
        ...
        Pass
        {
            ...
            Varyings CombinedShapeLightVertex(Attributes v)
            {
			    ...
			    float3 newPos = worldCenter
			                    + v.positionOS.x * objectScale.x * cameraRight
			                    + v.positionOS.y * objectScale.y * cameraUp
			                    + v.positionOS.z * objectScale.z * cameraForward;
			
			    o.positionCS = TransformWorldToHClip(newPos);
